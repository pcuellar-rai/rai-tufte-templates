...
and the use of the \doccls{rai-book} and \doccls{rai-handout} document classes, all built over the original Tufte book and handout classes. .
...
chapters,\sidenote{Parts and chapters are defined for the \texttt{rai-book}
...
\end{table}
        ...
        \chapter[On the Use of the rai-book Document Class]{On the Use of the \texttt{rai-book} Document Class}
\label{ch:rai-book}
...
\begin{table}[ht]
  ...
  \begin{tabular}{ll}
    ...
    \bottomrule
  \end{tabular}
  \caption{Here are the dimensions of the various margins used in the rai-handout class.}
  \label{tab:normaltab}
...
\index{class options|(}
The \doccls{rai-book} class is based on the \LaTeX\ \doccls{book}
document class.  Therefore, you can pass any of the typical book
options.  There are a few options that are specific to the
\doccls{rai-book} document class, however.
...
\docfilehook{rai-common-local.tex}{common}, \docfilehook{rai-book-local.tex}{book}, and
\docfilehook{rai-handout-local.tex}{handout}.\sloppy

\begin{description}
  \item[\docfilehook{rai-common-local.tex}{common}]
  ...
  \item[\docfilehook{rai-book-local.tex}{book}] 
  ...
  \item[\docfilehook{rai-common-handout.tex}{handout}] 
    If this file exists, it will be loaded after all of the common and
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{lr}
      ...
      Heading level & Value \\
      \midrule
      Part (in \doccls{rai-book}) & $-1$ \\
      Part (in \doccls{rai-handout}) & $0$ \\
      Chapter (only in \doccls{rai-book}) & $0$ \\
      Section & $1$ \\
      Subsection & $2$ \\
      Subsubsection & $3$ \\
      Paragraph & $4$ \\
...
\noindent For example, 
\begin{docspec}
  \doccmdnoindex{documentclass}[symmetric,justified,marginals=raggedouter]\{rai-book\}
\end{docspec}
...
\section{Converting from \doccls{article} to \doccls{rai-handout}}
...
\section{Converting from \doccls{book} to \doccls{rai-book}}
