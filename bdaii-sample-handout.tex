...
\title[Short Title for your BDAII Document]{{A Much Longer Title for your Report/Handout/Project Proposal}\thanks{Acknowledgement note: Inspired by Spot!}}
...
\begin{abstract}
\noindent
This document describes the Tufte handout \LaTeX\ document style for the The Boston Dynamics AI Institute. It builds on Edward Tufte's uses in his books and handouts. This document is a fork of Tufte's Handbook \LaTeX on this GitHub repository \url{https://github.com/Tufte-LaTeX/tufte-latex}. 
\end{abstract}
...
\end{docspec}
Multiple citations can have each its own number. You can use the \Verb|\multicite{ufte2006,Tufte1990}| command to do this as exemplified here \multicite{Tufte1990,Bringhurst2005}

\section{Figures and Tables}\label{sec:figures-and-tables}
The \texttt{/graphics} folder includes various image files for the branding of The AI Institute if you want to use them to change the title-page or for other purposes. 
